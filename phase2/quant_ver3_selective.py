...
# ver2_up_sep.py에 아이디어를 추가
# 기존에 있던 아이디어는 그냥 모든 layer에 동일한 방식 q/r를 적용하는 거였는데, 
# 이번에는 만약 base가 특정 값보다 작으면 q/r 아이디어 적용하지 않고 그냥 INT 4 QUANT하기
import argparse
import random
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="quotrem_ppl_results_v3_selective")
