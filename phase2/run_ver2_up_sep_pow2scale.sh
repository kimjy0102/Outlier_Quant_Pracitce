...
REPLACE_SCOPE="all"
OUTPUT_DIR="results/results_ver2_up_sep_pow2scale_q${Q_BITS}_r${R_BITS}_basegs${BASE_GROUP_SIZE}_rgs${R_GROUP_SIZE}"

echo "======================================================"
echo "Running Adaptive QR Quantization (pow2 residual scale)"
...
python quant_ver2_up_sep_pow2scale.py \
